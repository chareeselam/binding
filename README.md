...
Inline SVG: used to create the Penrose triangle

Single <img> asset: used on the Home page alongside the Colophon, containing the three shapes and primary colors used throughout the system
